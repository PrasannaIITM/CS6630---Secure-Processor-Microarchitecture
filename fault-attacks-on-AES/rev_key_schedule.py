...
def inv_sub_word(word: bytes) -> bytes:
    return bytes((invsbox[w] for w in word))

def print_rk(rk, name = ""):
    k = []
    for i in range(0, 32, 2):
        k.append(int(rk[i:i+2], 16))
    print(f"round {name}: {k}")

def reverse_key_schedule(round_key, rounds):
    for i in range(rounds - 1, -1, -1):
        ...
        print_rk(hexlify(round_key).decode(), i)
    return round_key

rk10 = "d9ec45689a0b2ce3862d0bdec60409ba"
print_rk(rk10, 10)
reverse_key_schedule(unhexlify(rk10), 10)
